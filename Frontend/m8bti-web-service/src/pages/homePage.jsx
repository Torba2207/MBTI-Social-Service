  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-200 px-4 sm:px-8 py-8 sm:py-12 flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center flex-1 gap-8">
          {/* Text */}
          <div className="max-w-2xl lg:max-w-4xl w-full flex flex-col items-left lg:items-start text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 sm:mb-28 leading-tight sm:leading-tight">
          ...
          {/* Image */}
          <div className="w-full max-w-md lg:max-w-2xl flex justify-center">
            <div className="relative w-full aspect-square max-w-[300px] sm:max-w-[400px] lg:max-w-[500px]">
              <Image 
                src="/icon.png" 
